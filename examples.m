...
load([data_path '/image_alignment/image_alignment']);
...
load([data_path '/tempo_segment/' data_name]);
    ...
    for k=1:length(choice)
        switch choice(k)
           ...
           % This slow function shows the gradients as little oriented arrows
            ...
            % estimation code by Marcin Eichner, Manuel J. Marín-Jiménez,  
            ...
            fprintf(2, '   EXTRACT SKELETON W. ETH CODE\nThis is a pre-recorded example of skeleton extraction. The code of Marcin Eichner, Manuel J. Marín-Jiménez, Andrew Zisserman, and Vittorio Ferrari is available from http://www.vision.ee.ethz.ch/~calvin/articulated_human_pose_estimation_code/\n');
            isd=1;
            if isd, 
                movie_type='K'; 
                M=K0;
